 ...
 <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-8 px-4 mt-[10vh] transition-colors duration-200">
    ...
    <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row items-center gap-3 mb-8">
            ...
            <div className="text-xs md:text-sm flex items-center gap-1 bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-300 px-3 py-1 rounded-full font-medium">
